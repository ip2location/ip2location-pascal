...
myst_html_meta = {
    "description": "IP2Location Pascal library that enables user to get the geolocation information from IP2Location BIN database.",
    "keywords": "IP2Location, Geolocation, IP location, Pascal",
